    ...
    <div class="col-12">
      <div class="card">
        ...
        >
          ...
          <Column field="image_url" header="Название" :sortable="true" h>
            <template #body="slotProps">
          ...
          <Column field="name" header="Категории" :sortable="true" h>
            <template #body="slotProps">
          ...
          <Column field="parent_id" header="Айди родителя" :sortable="true" h>
            <template #body="slotProps">
              <span class="p-column-title">Айди родителя</span>
          ...
          >
            <template #body="slotProps">
              <span class="p-column-title">Номер сортировки</span>
              {{ slotProps.data.sort_order }}
            </template>
          </Column>

          <Column field="type_img" header="тип картинок" :sortable="true" h>
            <template #body="slotProps">
              <span class="p-column-title">тип картинок</span>
              {{ slotProps.data.type_img }}
            </template>
          </Column>

          <Column field="user_id" header="Юзер айди" :sortable="true" h>
            <template #body="slotProps">
              <span class="p-column-title">Юзер айди</span>
